...
items = [
  ...
  { id:4,title: 'مدت زمان پشتیبانی از سایت طراحی شده چقدر است؟ ', content: 'بعد از تحویل سایت شما مشتریان عزیز 6ماه کاملا رایگان و به طور نامحدود شامل پشتیبانی خواهید بود', isOpen: false },
